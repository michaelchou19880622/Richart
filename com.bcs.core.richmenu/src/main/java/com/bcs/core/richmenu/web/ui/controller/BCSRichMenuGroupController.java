...
public class BCSRichMenuGroupController extends BCSBaseController {
	...
	@RequestMapping(method = RequestMethod.GET, value = "/edit/hpiRichMenuGroupListPage")
	public String hpiRichMenuGroupListPage(HttpServletRequest request, HttpServletResponse response) {
		log.info("hpiRichMenuGroupListPage");
