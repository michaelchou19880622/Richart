...
public class RichMenuSendGroupUIService {
	...
	public RichMenuSendGroup saveFromUI(RichMenuSendGroup sendGroup, String adminUserAccount) throws BcsNoticeException{
		...
		if(list != null){
			for(RichMenuSendGroupDetail detail : list){
