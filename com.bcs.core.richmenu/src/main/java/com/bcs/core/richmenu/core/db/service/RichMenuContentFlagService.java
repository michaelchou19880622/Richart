...
import com.bcs.core.richmenu.core.db.repository.RichMenuContentFlagRepository;
import com.bcs.core.db.repository.EntityManagerControl;

@Service
public class RichMenuContentFlagService {
	
	@Autowired
	private RichMenuContentFlagRepository contentFlagRepository;
	...
	public List<Object[]> findFlagValueByReferenceIdInAndContentTypeOrderByFlagValueAsc(List<String> referenceIds, String contentType){
		return contentFlagRepository.findFlagValueByReferenceIdInAndContentTypeOrderByFlagValueAsc(referenceIds, contentType);
	}
	...
	public void save(String referenceId, String contentType, List<String> flagValueList) {
		...
		for (String flagValue : flagValueList) {
			RichMenuContentFlag contentFlag = new RichMenuContentFlag();
