package com.bcs.core.richmenu.core.api.msg.model;

import com.bcs.core.json.AbstractBcsEntity;

public class RichMenuAction extends AbstractBcsEntity {
	...
	public RichMenuAction(String actionId, String actionText, String actionContent, int actionX, int actionY, int actionWidth, int actionHeight){
	...
	public RichMenuAction(String actionId, String actionType, String actionText, String actionContent, int actionX, int actionY, int actionWidth, int actionHeight){
