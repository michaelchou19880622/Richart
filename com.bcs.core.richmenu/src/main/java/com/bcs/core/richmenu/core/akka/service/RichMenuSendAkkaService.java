package com.bcs.core.richmenu.core.akka.service;
...
public class RichMenuSendAkkaService {
	...
	public RichMenuSendAkkaService() {
		new AkkaSystemFactory<RichMenuSendMasterActor>(actorSystemList, RichMenuMasterActorList, RichMenuSendMasterActor.class, "actorSystemList", "RichMenuMasterActorList");
	}
