package com.bcs.core.richmenu.enums;

import com.bcs.core.richmenu.core.db.entity.RichMenuSendGroup;

public enum RICH_MENU_DEFAULT_SEND_GROUP {
    ...
    RICH_MENU_DEFAULT_SEND_GROUP(Long groupId, String key, String title, String description, boolean isShow) {
	...
	public RichMenuSendGroup defaultGroup(){

		RichMenuSendGroup defaultGroup = new RichMenuSendGroup();
	...
	public static RICH_MENU_DEFAULT_SEND_GROUP getGroupByGroupId(Long groupId){
		for(RICH_MENU_DEFAULT_SEND_GROUP group : values()){
