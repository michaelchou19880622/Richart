...
@Entity
@Table(name = "BCS_RICH_MENU_MSG_CONTENT_LINK_TRACING")
public class RichMenuMsgContentLinkTracing extends AbstractBcsEntity{
	...
	public RichMenuMsgContentLinkTracing(){
	...
	public RichMenuMsgContentLinkTracing(String linkId){
		this.linkId = linkId;
	}
