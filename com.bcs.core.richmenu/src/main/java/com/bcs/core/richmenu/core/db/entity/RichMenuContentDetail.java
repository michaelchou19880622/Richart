...
@Entity
@Table(name = "BCS_RICH_MENU_CONTENT_DETAIL",
indexes = {
	       @Index(name = "BCS_RICH_MENU_CONTENT_DETAIL_0", columnList = "RICH_ID"),
	       @Index(name = "BCS_RICH_MENU_CONTENT_DETAIL_1", columnList = "LINK_ID"),
	})
public class RichMenuContentDetail extends AbstractBcsEntity{
