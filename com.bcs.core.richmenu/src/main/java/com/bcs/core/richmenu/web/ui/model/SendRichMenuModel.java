package com.bcs.core.richmenu.web.ui.model;
...
public class SendRichMenuModel extends AbstractBcsEntity{
	...
	private List<SendRichMenuDetailModel> sendMsgDetails;
	...
	public List<SendRichMenuDetailModel> getSendMsgDetails() {
		return sendMsgDetails;
	}

	public void setSendMsgDetails(List<SendRichMenuDetailModel> sendMsgDetails) {
