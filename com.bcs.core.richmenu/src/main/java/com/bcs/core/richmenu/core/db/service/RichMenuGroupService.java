...
//	private RichMenuContentFlagService contentFlagService;
   ...
   /**
	 * 取得Rich Menu Group所有清單
   */
  	public List<RichMenuGroup> getAllRichMenuGroupByStatus(String status){
		return richMenuGroupRepository.findByStatus(status);
  	}

  	// Save Rich Menu Group
...
//		DataSyncUtil.settingReSync(RICHMENUGROUP_SYNC);
//	}
//    
//    /**
//	 * 停用圖文選單
