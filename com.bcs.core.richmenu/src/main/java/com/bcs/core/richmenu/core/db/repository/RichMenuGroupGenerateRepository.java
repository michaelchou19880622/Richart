...
public class RichMenuGroupGenerateRepository{
	...
	private Query buildFindQuery(List<RichMenuSendGroupDetail> sendGroupDetails, String selectColumns) throws Exception {
	 ...
	 * @throws Exception 
	 */
	private Query buildFindQuery(List<RichMenuSendGroupDetail> sendGroupDetails, String selectColumns, String mid) throws Exception {
		Validate.notEmpty(sendGroupDetails);
		Validate.notEmpty(selectColumns);
		
		List<RichMenuSendGroupDetail> sendGroupSetting = new ArrayList<RichMenuSendGroupDetail>();
		List<RichMenuSendGroupDetail> uploadMidSetting = new ArrayList<RichMenuSendGroupDetail>();
		
		// 分離 Upload Mid Detail Setting
		for(RichMenuSendGroupDetail detail : sendGroupDetails){
	...
	private String generateMidFieldSettingFrom(List<RichMenuSendGroupDetail> sendGroupDetails, int params){
		...
		if(sendGroupDetails != null && sendGroupDetails.size() > 0){
			...
			RichMenuSendGroupDetail detail = sendGroupDetails.get(0);
	 ...
	 * @return
	 */
	private String generateUploadMidSettingFrom(List<RichMenuSendGroupDetail> sendGroupDetails, int params){
	 ...
	 * @param sendGroupDetails
	 */
	private void checkSendGroupDetail(List<RichMenuSendGroupDetail> sendGroupDetails) {
		for (RichMenuSendGroupDetail sendGroupDetail : sendGroupDetails) {
