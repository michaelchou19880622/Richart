...
public class CreateRichMenuModel extends AbstractBcsEntity{
	private static final long serialVersionUID = 1L;
	
	private List<CreateRichMenuModel> richMenuImgUrls;
	...
	public void setRichMsgImgUrls(List<CreateRichMenuModel> richMenuImgUrls) {
