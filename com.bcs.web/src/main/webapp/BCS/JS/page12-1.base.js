...
$(function(){
	$('.btn_add').click(function(){
 		window.location.replace(bcs.bcsContextPath +'/edit/interactiveResponseCreatePage?from=interactiveResponseDisablePage');
	});
	...
	var btn_copyFunc = function(){
		...
		console.info('btn_copyFunc iMsgId:' + iMsgId);
 		window.location.replace(bcs.bcsContextPath + '/edit/interactiveResponseCreatePage?iMsgId=' + iMsgId + '&actionType=Copy&from=interactiveResponseDisablePage');
	};
	...
	var loadDataFunc = function(){
		...
		$.ajax({
			...
			for(key in response.MsgMain){
				...
				msgData.find('.mainKeyword a').attr('href', bcs.bcsContextPath +'/edit/interactiveResponseCreatePage?iMsgId=' + iMsgId + '&actionType=Edit&from=interactiveResponseDisablePage');
