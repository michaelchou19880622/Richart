$(function(){
	...
	var getMaxPageNum = function(startDate, endDate, cb){
		...
		if(startDate || endDate)
			url = bcs.bcsContextPath + '/edit/getRewardCardRecordMaxPage?rewardCardId=' + rewardCardId + '&startDate=' + startDate + '&endDate=' + endDate;
	...
	var queryRecords = function() {
		...
		getMaxPageNum(startDate, endDate, function() {
			$.ajax({
				type : "GET",
	...
	initPage();
	getMaxPageNum(null, null, function(){
		loadDataFunc();
	});
});