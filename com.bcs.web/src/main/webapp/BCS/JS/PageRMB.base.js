...
$(function(){
	...
	var sendingMsgFunc = function(actionType){
		...
		var richMenuGroupId = mainList.options[mainList.selectedIndex].value;
		if (richMenuGroupId == "") {
			alert('請選擇RichMenu');
			return;
		} 	
		...
		$.ajax({
			type : "POST",
			url: bcs.bcsContextPath + '/edit/richMenuBinding?richMenuGroupId='+richMenuGroupId,
            cache: false,
	...
	var loadDataFunc = function(){
		...
		$.ajax({
			type : "GET",
			// /market/getUndoneManualLinePointMainList 
