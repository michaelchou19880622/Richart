		...
		$.ajax({
			...
			url : bcs.bcsContextPath + '/edit/countWinningLetterReplyPeople?winningLetterId=' + winningLetterId
				...
				function(response) {
					...
					dataTemplateBody.find('.replyPeople a').attr('href',
							encodeURI(bcs.bcsContextPath + '/admin/winningLetterReplyListPage?wlId=' + winningLetterId + '&wlName=' + winningLetterName + '&wlReplyCount=' + replyCount)).html(replyCount);
				}).fail(function(response) {
			console.info(response);
			$.FailResponse(response);
		})
			...
			url : encodeURI(bcs.bcsContextPath + '/edit/getWinningLetterList?name=' + keywordValue + '&status=' + pageStatus)
				...
				function(response) {
					...
					$.each(response, function(i, o) {
						...
						// 名稱
						dataTemplateBody.find('.winningLetterName a').attr('href', bcs.bcsContextPath + '/admin/winningLetterMainPage?id=' + o.id + '&actionType=Edit' + '&isExpired=' + isExpired)
								.html(o.name);
