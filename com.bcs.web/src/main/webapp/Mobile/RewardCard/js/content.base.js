...
$(function() {
	...
	var loadDataFunc = function() {
		...
		var couponList = CONTENTCOUPONS;// CONTENTCOUPONS 由 html 的
										// modelAttribute 獲取

		if (couponList != null) {
			couponList.sort(function(x, y) {
				return x.requirePoint - y.requirePoint;
			});
			...
			$.each(couponList, function(i, couponData) {
				...
				if (couponData.status == COUPON_STATUS.STATUS_GOTTEN.statusCode || couponData.status == COUPON_STATUS.STATUS_CAN_GET.statusCode
