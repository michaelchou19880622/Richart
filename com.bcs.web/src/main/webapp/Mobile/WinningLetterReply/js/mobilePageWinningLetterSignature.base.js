$(function() {
	...
	// // var winner_phoneNumber =
	// document.getElementById("winner_phoneNumber");
	// // var winner_residentAddress =
	// // document.getElementById("winner_residentAddress");
	// // var winner_mailingAddress =
	// // document.getElementById("winner_mailingAddress");
	...
	//
	// // 通訊地址
	// var data_MailingAddress = ((cb_address.checked) ? data_ResidentAddress :
	// winner_mailingAddress.value);
	...
	// $.ajax({
	// type : "GET",
	// url : encodeURI(bcs.mContextPath +
	// "/wl/getWinningLetter?winningLetterId=" + winningLetterId)
