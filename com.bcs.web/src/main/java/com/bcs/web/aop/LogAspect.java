...
import com.bcs.core.richart.akka.service.RichartAkkaService;
...
public class LogAspect {
	...
	private static String getIp(Object[] args) {
		...
		//get Ip
		String ip = (request != null) ? IpUtil.getIP(request) : null;
	...
	private static String getAccountAndMid(Object[] args) {
		...
		String accountAndMid = (customUser != null)? customUser.getAccount() + "," + (customUser.getMid() != null ? customUser.getMid() : "MidNull"): null;
		return accountAndMid;
	}
