...
public interface ShareUserRecordRepository extends EntityRepository<ShareUserRecord, String>{
    ...
    @Query(value = "SELECT " 
    				...
    				+ "FROM "
		    		+ "BCS_SHARE_CAMPAIGN_CLICK_TRACING " 
		    		+ "LEFT JOIN BCS_SHARE_USER_RECORD ON (BCS_SHARE_CAMPAIGN_CLICK_TRACING.SHARE_USER_RECORD_ID = BCS_SHARE_USER_RECORD.SHARE_USER_RECORD_ID) " 
		    		+ "LEFT JOIN BCS_SHARE_DONATOR_RECORD ON (BCS_SHARE_CAMPAIGN_CLICK_TRACING.UID = BCS_SHARE_DONATOR_RECORD.DONATOR_UID AND BCS_SHARE_CAMPAIGN_CLICK_TRACING.SHARE_USER_RECORD_ID = BCS_SHARE_DONATOR_RECORD.SHARE_USER_RECORD_ID) " 
			    	...
			    	+ "WHERE " 
				    	...
				    	+ "AND BCS_SHARE_USER_RECORD.CUMULATIVE_COUNT >= "
				    	+ "( "
				    		+ "SELECT "
				    		+ "SHARE_TIMES "
				    		+ "FROM "
				    		+ "BCS_SHARE_CAMPAIGN "
				    		+ "WHERE "
				    		+ "BCS_SHARE_CAMPAIGN.CAMPAIGN_ID = BCS_SHARE_USER_RECORD.CAMPAIGN_ID"
				    	+ ") " 
			    	+ "GROUP BY " 
