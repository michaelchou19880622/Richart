...
//                " AND BCS_ACTION_USER_COUPON.ACTION_TYPE ='GET'";
        ...
        String queryString = "SELECT " +
                ...
                " BCS_CONTENT_COUPON.IS_FILL_IN" +
                " FROM BCS_ACTION_USER_COUPON" +
                " JOIN BCS_CONTENT_COUPON ON BCS_ACTION_USER_COUPON.COUPON_ID = BCS_CONTENT_COUPON.COUPON_ID" +
                " JOIN BCS_WINNER_LIST ON BCS_WINNER_LIST.WINNER_LIST_ID = BCS_ACTION_USER_COUPON.WINNER_LIST_ID" +
                " JOIN BCS_CONTENT_COUPON_CODE ON BCS_ACTION_USER_COUPON.COUPON_CODE_ID = BCS_CONTENT_COUPON_CODE.COUPON_CODE_ID" +
                " WHERE BCS_CONTENT_COUPON.EVENT_REFERENCE = 'REWARD_CARD' AND BCS_CONTENT_COUPON.EVENT_REFERENCE_ID = ?1" +
                " AND BCS_ACTION_USER_COUPON.ACTION_TYPE = 'GET'";
