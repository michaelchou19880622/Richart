...
@Entity
@Table(name = "BCS_USER_UPLOAD_LIST",
	indexes = {
	       @Index(name = "INDEX_0", columnList = "REFERENCE_ID"),
	       @Index(name = "INDEX_1", columnList = "IS_EXIST"),
	       
	})
public class UserUploadList extends AbstractBcsEntity{
	...
	public void setReferenceId(String referenceId) {
		...
		if(StringUtils.isNotBlank(this.referenceId) && this.referenceId.length() > 100){
			this.referenceId = this.referenceId.substring(0, 99);
		}
	}
