...
//        in.read(bFile);
	...
	public static ContentResource uploadFile(InputStream inputStream, String resourceTitle, Long resourceSize, String contentType, String resourceType, String modifyUser) throws Exception {
		return uploadFile(inputStream, resourceTitle, resourceSize, contentType, resourceType, modifyUser, null, true, false);
	}

	private static ContentResource uploadFile(String filePath, BufferedOutputStream out, BufferedInputStream in, File genfile, String resourceId, String resourceTitle, Long resourceSize,
			String resourceType, String modifyUser, String contentType, boolean saveToDb, boolean saveToDisk) throws Exception {
		...
		if (ContentResource.RESOURCE_TYPE_AUDIO.equals(resourceType)) {
			...
			log.info("uploadFile previewPath:" + previewPath);
...
//			updateImageResource(genfile, resource);
	...
	public static ContentResource uploadFile(InputStream inputStream, String resourceTitle, Long resourceSize, String contentType, String resourceType, String modifyUser, String resourceId,
			boolean saveToDb, boolean saveToDisk) throws Exception {
	...
	private static BufferedImage resizeImageForPreview(File file) {
		log.info("resizeImageForPreview");
		...
		try {
			...
			log.info("toHeight = {}, toWidth = {}", toHeight, toWidth);
		...
		if (resource != null) {
			...
			if (!file.exists()) {
				...
				if (resourceFile != null) {
					...
					uploadFile(inputStream, resource.getResourceTitle(), resource.getResourceSize(), resource.getContentType(), resource.getResourceType(), resource.getModifyUser(),
							resource.getResourceId(), false, true);
					log.info("loadFromDB success:" + resource);
					return true;
				}
			}
		}
