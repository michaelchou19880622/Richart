...
public class MultipartFileSender {
    ...
    public static MultipartFileSender fromContentResource(ContentResource resource) {
        ...
        Path path = Paths.get(filePath, resource.getResourceId());
    ...
    public void serveResource(String contentType) throws Exception {
