...
public class LinePointFtpTaskActor extends UntypedActor {
...
//					record.setSourceType(LinePointPushMessageRecord.SOURCE_TYPE_FTP);
...
//					record.setReservationTime(sendType.equals(LinePointPushModel.SEND_TYPE_DELAY) ? ftpTaskModel.getFileHead().getScheduledTime() : null);
