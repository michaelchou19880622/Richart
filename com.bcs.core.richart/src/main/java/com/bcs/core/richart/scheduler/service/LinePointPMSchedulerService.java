...
public class LinePointPMSchedulerService {
	...
	public LinePointPMSchedulerService() {
	}
	...
	public void startCircle() throws SchedulerException, InterruptedException {
		...
		try {
			// get start time
			String startTimeStr = CoreConfigReader.getString(CONFIG_STR.LINE_POINT_PM_START_TIME, true);
...
//		}, delay, 86400, TimeUnit.SECONDS);
	...
	public void destroy() {
		if (scheduledFuture != null) {
			...
			logger.info(" LinePointPMSchedulerService cancel....");
		}
		if (scheduler != null && !scheduler.isShutdown()) {
			logger.info(" LinePointPMSchedulerService shutdown....");
			scheduler.shutdown();
		}
	}
