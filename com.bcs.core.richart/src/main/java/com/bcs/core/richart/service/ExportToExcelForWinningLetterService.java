...
//			List<Object[]> lst_winningLetterSummaryReport = winningLetterRecordRepository.findSummaryReportByLikeNameAndStatus(wlName, wlStatus);
...
//			logger.info("[ exportToExcelForWinnerReplyListByWinningLetterId ] lst_winningLetterSummaryReport = {}", lst_winningLetterSummaryReport);
